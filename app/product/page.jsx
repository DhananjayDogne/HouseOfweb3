...
//                             <button onClick={handleAddToCart} className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Add to Cart</button>
//                             <button onClick={handleFavorite} className="bg-yellow-500 text-white px-4 py-2 rounded-md hover:bg-yellow-600">Favorite</button>
//                         </div>
//                     </div>
//                 </motion.div>
//             )}
...
import { useState, useEffect } from 'react';
import { useSearchParams } from "next/navigation";
import { FaHeart } from 'react-icons/fa'; // Import heart icon from Heroicons
